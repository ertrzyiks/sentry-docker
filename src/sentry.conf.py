...
if 'DATABASE_URL' in os.environ:
    ...
    POSTGRES_DBNAME=dbUrl.path[1:]
    POSTGRES_USER=dbUrl.username
    POSTGRES_PASSWORD=dbUrl.password
    POSTGRES_HOST=dbUrl.hostname
    POSTGRES_PORT=dbUrl.port
else:
...
BROKER_URL = 'redis://' + REDIS_HOST + ':' + str(REDIS_PORT)
...
SENTRY_URL_PREFIX = os.environ['BASE_URL']  # No trailing slash!
...
SECRET_KEY = 'U1iJUhEPQSq8HSIpDdU9wpByFZFwAzVfVai1POgZXfHWLX40w8J+qQ=='
